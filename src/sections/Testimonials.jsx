...
export default function Testimonials() {
  return (
    <section id="depoimentos" className="py-20 md:py-28 bg-burgundy-gradient relative overflow-hidden">
        ...
        <div className="mt-14 grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, i) => (
            <motion.figure
              ...
              className="relative rounded-2xl glass-dark gilded-border p-8"
            >
